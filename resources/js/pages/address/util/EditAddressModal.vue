                ...
                <v-card color="grey lighten-3">
                    <v-card-title>
                        <div class="flex justify-between md:px-10">
                            ...
                            <button
                                type="button"
                                @click="$emit('close-modal-edit-address')"
                            >
...
export default {
        ...
        show(val) {
            if (val) {
                this.form = JSON.parse(
                    JSON.stringify({ ...this.address, _method: "PUT" })
                );
            }
        },
    },
    ...
    methods: {
        ...
        updateDirection() {
            ...
            const endpoint = `${this.ep.shippingAddress.update + this.form.id}`;
