    ...
    <div class="home-login">
        ...
        <div class="wrap-login p-2">
            <div class="row" style="margin: 0px; padding: 0px">
                <div
                    class="col-12 d-none d-lg-flex justify-content-md-end"
                    v-if="indexForm == 0"
                >
                    <div
                        class="login-form-logo d-flex justify-content-center"
                        style="width: 544px; margin-right: 12rem"
                    >
                        <img
                ...
                <div
                    class="col-12 d-flex justify-content-md-end justify-content-xs-center"
                                    ...
                                    <tab-content icon=" ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div
                                                    class="container-login-form-btn"
                                                >
                                                    <button
                                    ...
                                    <tab-content icon=" " v-if="perfil == 2">
                                        ...
                                        >
                                            ...
                                            <v-text-field
                                                ...
                                                required
                                                @input="
                                                    $v.consejeria_ayuntamiento.$touch()
                                                "
                                                @blur="
                                                    $v.consejeria_ayuntamiento.$touch()
                                                "
                            ...
                            <div v-else>
                                ...
                                <div style="text-align: center">
                                    ...
                                    <h6>
                                        ...
                                        Fecha de nacimiento: {{ dateFormatted }}
                                    </h6>
                                    <h6>
                                        <i class="mdi mdi-account-outline"></i>
                                        Sexo: {{ select_sexo.state }}
                                    </h6>
                                    <h6>
                                        <i class="mdi mdi-flag-outline"></i>
                                        País: {{ select_pais.state }}
                                    </h6>
                                    <h6>
                                        <i
                                            class="mdi mdi-microphone-outline"
                                        ></i>
                                        Idioma: {{ select_idioma.state }}
                                    </h6>
                                </div>
