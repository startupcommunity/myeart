                        ...
                        <div class="flex flex-col space-y-5">
                            <div class="w-full">
                                <div class="flex justify-between items-center">
                                    <h1
                                        class="font-bold text-3xl text-zinc-900"
                                    >
                                ...
                                <p>
                                    ...
                                    {{ email }}. Myeart le enviará cualquier
                                ...
                                <p>Myeart no ofrece garantías.</p>
                                <p>
