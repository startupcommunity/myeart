            ...
            <td valign="middle" class="hero hero-2 bg_white" style="padding: 4em 0;">
                <div style="padding: 2rem; text-align: center;">
                    ...
                    <h5>
                        ...
                        <p>
                            por favor confirma tu correo electrónico para poder acceder a tu cuenta siguiendo
                            el siguiente enlace:
                        </p>

                        <p>
                            <a href="{{ route('confirmRegisterEmail', $user->userConfirmRegister->token) }}">
                                {{ route('confirmRegisterEmail', $user->userConfirmRegister->token) }}
                            </a>
                        </p>
                    </h5>
                </div>
