...
class CreateArtworkRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'width' => 'required_if:state,1|nullable|max:1000',
            'large' => 'required_if:state,1|nullable|max:1000',
            'weight' => 'required_if:state,1|nullable|max:1000',
            'price' => 'required_if:state,1|nullable|max:999999999999',
