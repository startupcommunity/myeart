  ...
  methods: {
    ...
    likeOrDislike: function likeOrDislike() {
      ...
      this.axios.post(endpoint + id).then(function (resp) {
        ...
        return (
          /* eslint-disable */
          oo_oo(), console.log(error, "46821f03_0")
        );
      })["finally"](function () {
    ...
    addView: function addView() {
      ...
      this.axios.post(this.ep.artworks.addVisit, data).then(function () {
        return (
          /* eslint-disable */
          oo_oo(), console.log("visita agregada con éxito", "46821f03_1")
        );
      })["catch"](function (error) {
        return (
          /* eslint-disable */
          oo_oo(), console.log(error, "46821f03_2")
        );
      });
    },
  ...
  methods: {
    ...
    likeOrDislike: function likeOrDislike(id) {
      ...
      this.axios.post(endpoint + id).then(function (resp) {
        ...
        return (
          /* eslint-disable */
          oo_oo(), console.log(error, "c60c9116_0")
        );
      })["finally"](function () {
