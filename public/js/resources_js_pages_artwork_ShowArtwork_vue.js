  ...
  methods: {
    ...
    likeOrDislike: function likeOrDislike() {
      ...
      this.axios.post(endpoint + id).then(function (resp) {
        ...
        return (
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("d950add5_0", error)))
        );
      })["finally"](function () {
    ...
    addView: function addView() {
      ...
      this.axios.post(this.ep.artworks.addVisit, data).then(function (_) {
        ...
        return (
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("d950add5_1", error)))
        );
      });
    },
  ...
  methods: {
    ...
    likeOrDislike: function likeOrDislike(id) {
      ...
      this.axios.post(endpoint + id).then(function (resp) {
        ...
        return (
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("261c1b5f_0", error)))
        );
      })["finally"](function () {
...
var render = function render() {
  ...
  }, [_vm._v("\n                                " + _vm._s(_vm.euro) + " " + _vm._s(_vm.artwork.total) + "\n                            ")])])]), _vm._v(" "), !_vm.hasOwner ? _c("div", {
    staticClass: "py-2"
  }, [_c("v-btn", {
    attrs: {
      large: "",
