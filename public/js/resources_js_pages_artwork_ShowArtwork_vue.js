  ...
  methods: {
    ...
    likeOrDislike: function likeOrDislike() {
      ...
      this.axios.post(endpoint + id).then(function (resp) {
        ...
        return (
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("ffb0198e_0", error)))
        );
      })["finally"](function () {
    ...
    addView: function addView() {
      ...
      this.axios.post(this.ep.artworks.addVisit, data).then(function (_) {
        ...
        return (
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("ffb0198e_1", error)))
        );
      });
    },
