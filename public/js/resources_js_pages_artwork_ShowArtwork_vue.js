...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    loadData: function loadData() {
      ...
      this.axios.get(this.ep.artworks.show + id).then(function (resp) {
        if (resp.status !== 200) return false; // data

        var _resp$data = resp.data,
            gallery = _resp$data.gallery,
            views = _resp$data.views; // obra

        _this2.artwork = resp.data; // load galeria

        _this2.loadGallery(gallery); // si esta like por el usuario


        _this2.isLiked(); // cargar las views


        _this2.loadView(views); // agregar una visita
    ...
    likeOrDislike: function likeOrDislike() {
      ...
      this.axios.post(endpoint + id).then(function (resp) {
        ...
        return (
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("5f0f0891_0", error)))
        );
      })["finally"](function () {
    ...
    addView: function addView() {
      ...
      this.axios.post(this.ep.artworks.addVisit, data).then(function (_) {
        ...
        return (
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("5f0f0891_1", error)))
        );
      });
    },
