  ...
  methods: {
    ...
    getItems: function getItems() {
      ...
      this.axios.get(this.ep.carts.getItems).then(function (response) {
        ...
        _this.intent = data[data.length - 1].intent;
        _this.items = data;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  /* eslint-disable */
                  ;
                  oo_oo(), console.log(_this2.client_secret, "71f5641e_0");
                  _context2.next = 4;
                  return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_9__.loadStripe)("pk_test_51MW1rzC7iDkcq7NnZS084fArluUs8ckEQk1J7nIylPSIEPfIxLMM6IiXptIs6rX212ReXAiTFfRbh6rVphJN2zYI00ORsr553i");

                case 4:
                  _this2.stripe = _context2.sent;
                  options = {
                    clientSecret: _this2.client_secret
                  };
                  elements = _this2.stripe.elements(options);
     ...
     * finalizar compras
     */
    finalPurchase: function finalPurchase() {
      var _this$paymentMethod,
          _this4 = this;

      // cargar datos de envió
      this.setShippingAddressInfo(); // validar que exista una dirección

      if (!this.isShippingAddressInfo) {
        var msj = "Debes llenar la dirección de envío";
        this.noty(msj, "error");
        return;
      }
      ...
      var data = {
        ...
        payment_method_id: ((_this$paymentMethod = this.paymentMethod) === null || _this$paymentMethod === void 0 ? void 0 : _this$paymentMethod.id) || null
      };
      this.axios.post(this.ep.carts.finish, data).then(function (resp) {
        if (resp.status === 200) {
          _this4.$store.dispatch("userRequest");
        ...
        _this4.noty("Hubo un problema para finalizar su pedido", "error");
      })["catch"](function (error) {
    ...
    processPayment: function processPayment() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var _yield$_this5$stripe$, paymentMethod, error, msj;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _this5.stripe.createPaymentMethod("card", _this5.cardElement, {
                  billing_details: {
              ...
              case 2:
                _yield$_this5$stripe$ = _context3.sent;
                ...
                msj = _this5.manageStripeErrors(error);

                _this5.noty(msj, "error");

                return _context3.abrupt("return");

              case 9:
                // procesar pago
                _this5.paymentMethod = paymentMethod;

                _this5.finalPurchase();
...
var render = function render() {
  ...
  return _c("MainLayout", {
    ...
    on: {
      finalPurchase: _vm.finalPurchase,
    ...
    staticClass: "py-3 border mb-3",
    attrs: {
      id: "card-element"
    }
  }), _vm._v(" "), _c("button", {
    staticClass: "px-3 py-2 bg-gray-900 text-white hover:text-gray-200 transition-all ease-out",
    on: {
