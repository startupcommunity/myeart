  ...
  methods: {
    ...
    checkConversation: function checkConversation() {
      ...
      this.axios.post(this.ep.conversations.check, data).then(function (resp) {
        return _this2.chatID = resp.data.id;
      }).then(function (_) {
        return _this2.loadMessages();
      })["catch"](function (error) {
    ...
    loadMessages: function loadMessages() {
      ...
      this.axios.get(ep).then(function (resp) {
        return _this3.messages = resp.data;
      })["catch"](function (error) {
        return _this3.manageError(error);
      })["finally"](function () {
        if (indicateUpdate) _this3.loading = false;
      });
    },
      ...
      this.confirmedDialog({
        ...
        if (result.isConfirmed) {
          ...
          if (_this2.collectiveID) {
            ...
            /* eslint-disable */
            (_console = console).log.apply(_console, _toConsumableArray(oo_oo("f8d014e1_0", "entro al colectivo")));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    ...
    "window.innerWidth": function windowInnerWidth(val) {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("5c0bdaa7_0", val)));
    }
  },
  methods: {
    /**
    ...
    getEvents: function getEvents() {
      ...
      this.loading = true;
      this.axios.get(this.ep.events.getAll, {
        params: {
          sortBy: 1
        }
      }).then(function (resp) {
    ...
    toggleChat: function toggleChat(chat) {
      ...
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("5c0bdaa7_1", this.chats)));
    },
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      click: function click($event) {
        $event.stopPropagation();
        return _vm.$emit("closeChat", _vm.chat.id);
      }
    }
  }, [_c("i", {
...
var render = function render() {
  ...
  return _c("MainLayout", {
    ...
    staticClass: "mt-5"
  })], 1) : _vm._e(), _vm._v(" "), _c("CreateReleaseSection", {
    on: {
  ...
  }, [_vm.releases.length ? _c("div", [_vm._l(_vm.releases, function (release) {
...
var render = function render() {
  ...
  }), _vm._v(" "), _vm.showBtnChat ? _c("button", {
