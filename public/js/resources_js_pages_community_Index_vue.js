...
/* harmony import */ var _chat_mixins_useChat__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./../chat/mixins/useChat */ "./resources/js/pages/chat/mixins/useChat.js");
var _components;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "Index",
  mixins: [_chat_mixins_useChat__WEBPACK_IMPORTED_MODULE_13__["default"]],
  ...
  watch: {
    ...
    "window.innerWidth": function windowInnerWidth(val) {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("4434e656_0", val)));
    }
  },
  methods: {
    /**
