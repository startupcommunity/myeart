  ...
  methods: {
    ...
    getArtworks: function getArtworks() {
      ...
      return this.axios.get("/api/artworks").then( /*#__PURE__*/function () {
        ...
        return (
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("a236fef_0", error)))
        );
      })["finally"](function () {
    ...
    deleteArtwork: function deleteArtwork(id) {
      ...
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("a236fef_1", this.getStateActive)));
