  ...
  methods: {
    ...
    getArtworks: function getArtworks() {
      ...
      return this.axios.get("/api/artworks").then( /*#__PURE__*/function () {
        ...
        return (
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3be046_0", error)))
        );
      })["finally"](function () {
    ...
    deleteArtwork: function deleteArtwork(id) {
      ...
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3be046_1", this.getStateActive)));
...
var render = function render() {
  ...
  return _c("div", {
    ...
    }, [_vm._v("\n                                    " + _vm._s(_vm.euro) + " " + _vm._s((_art$total = art.total) !== null && _art$total !== void 0 ? _art$total : 0) + "\n                                ")])]), _vm._v(" "), art.state !== _vm.STATEARTWORK.sold ? _c("div", {
