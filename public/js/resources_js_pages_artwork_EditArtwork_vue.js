...
/* harmony import */ var _util_text__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../util/text */ "./resources/js/util/text.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _this.axios.get(_this.ep.artworks.edit + id).then(function (resp) {
                  ...
                  return (
                    /* eslint-disable */
                    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("7c167978_0", error)))
                  );
                })["finally"](function () {
    ...
    updateArtwork: function updateArtwork() {
      ...
      if (this.form.state === 1 || this.publish) {
        if (!this.$refs.artworkForm.validate()) {
          return this.$noty(_util_text__WEBPACK_IMPORTED_MODULE_11__.REQUIRED_FIELDS, "error", 5000);
        }
      } // cargar datos
    ...
    confirmUpdate: function confirmUpdate() {
      ...
      var title = this.publish ? _util_text__WEBPACK_IMPORTED_MODULE_11__.CONFIRM_PUBLISH_ARTWORK : _util_text__WEBPACK_IMPORTED_MODULE_11__.CONFIRM_DRAFT_ARTWORK;
      var msjBtn = this.publish ? _util_text__WEBPACK_IMPORTED_MODULE_11__.YES_PUBLISH : _util_text__WEBPACK_IMPORTED_MODULE_11__.YES_DRAFT;
      this.$swal.fire({
        title: title,
        ...
        cancelButtonText: _util_text__WEBPACK_IMPORTED_MODULE_11__.CANCEL
