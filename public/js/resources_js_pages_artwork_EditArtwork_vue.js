...
/* harmony import */ var _components_AlertPayment_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/AlertPayment.vue */ "./resources/js/pages/artwork/components/AlertPayment.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _this.axios.get(_this.ep.artworks.edit + id).then(function (resp) {
                  ...
                  return (
                    /* eslint-disable */
                    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("42f30c8c_0", error)))
                  );
                })["finally"](function () {
    ...
    updateArtwork: function updateArtwork() {
      ...
      var ep = this.ep.artworks.update + this.form.id;
      this.state = parseInt(data.get("state")); // request
      // loading
      ...
      this.axios.post(ep, data, this.headerFormData).then(function (resp) {
        if (resp.status === 200) {
          // mensaje
          _this2.loadSuccessMessage(); // const draftMsj = "Obra guardada como borrador";
          ...
          _this2.typeArtwork = _this2.isCollective ? 2 : 1;
          _this2.artCollectiveID = _this2.collectiveId;

          _this2.redirectAccordingTypeArtwork(); // if (!this.isCollective) {
          //     // obra de artista
