...
/* harmony import */ var _sections_Hero_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./sections/Hero.vue */ "./resources/js/pages/landing/sections/Hero.vue");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    // BreakingNews,
    Hero: _sections_Hero_vue__WEBPACK_IMPORTED_MODULE_8__["default"]
  },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    loadReleases: function loadReleases() {
      ...
      this.loading = true;
      this.axios.get(this.ep.releases.getAll).then(function (response) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    loadArtworks: function loadArtworks() {
      ...
      this.loading = true;
      this.axios.get(this.ep.artworks.getPublish).then(function (response) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    loadArtists: function loadArtists() {
      ...
      this.loading = true;
      this.axios.get(this.ep.user.getRandomArtists, {
        params: params
  ...
  return _c("div", {
    ...
    return _c("div", {
      ...
      attrs: {
        ...
        isOwner: _vm.user && _vm.user.id === release.creator.id
      },
      on: {
