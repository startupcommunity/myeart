          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              if (resp.length === 0) {
                ...
                (_console = console).log.apply(_console, _toConsumableArray(oo_oo("8b594a91_0", _this.hasPaymentMethod)));
              }
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                if (resp.length === 0) {
                  ...
                  (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("8b594a91_1", _this2.hasPaymentMethod)));
                }
