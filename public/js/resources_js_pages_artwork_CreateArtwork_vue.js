...
/* harmony import */ var _utils_CommonMixin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/CommonMixin */ "./resources/js/pages/artwork/utils/CommonMixin.js");
/* harmony import */ var _utils_createRulesMixin__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/createRulesMixin */ "./resources/js/pages/artwork/utils/createRulesMixin.js");
/* harmony import */ var _utils_uploadFilesMixin__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/uploadFilesMixin */ "./resources/js/pages/artwork/utils/uploadFilesMixin.js");
...
/* harmony import */ var _mixins_getDataMixin__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../mixins/getDataMixin */ "./resources/js/mixins/getDataMixin.js");
/* harmony import */ var _mixins_requestErrorsMixin__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../mixins/requestErrorsMixin */ "./resources/js/mixins/requestErrorsMixin.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  name: "CreateArtwork",
  mixins: [_utils_createRulesMixin__WEBPACK_IMPORTED_MODULE_7__["default"], _mixins_utilMixin__WEBPACK_IMPORTED_MODULE_9__["default"], _mixins_getDataMixin__WEBPACK_IMPORTED_MODULE_10__["default"], _mixins_requestErrorsMixin__WEBPACK_IMPORTED_MODULE_11__["default"], _utils_uploadFilesMixin__WEBPACK_IMPORTED_MODULE_8__["default"], _utils_CommonMixin__WEBPACK_IMPORTED_MODULE_6__["default"]],
  data: function data() {
    return {
      form: {
        title: "",
  ...
  methods: {
    ...
    saveArtwork: function saveArtwork() {
      ...
      data.append("state", this.isDraft); // data sync
      ...
      this.axios.post(this.ep.artworks.save, data, {
        headers: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.loading = true;
                ready = _this.getSubCategories(category_id);
                ready.then(function () {
     ...
     */
    loadLabels: function loadLabels(cat) {
      var _this2 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this2.loading = true;
                ready = _this2.getSubLabels(cat.category_id, cat.sub_category_id);
                ready.then(function () {
...
var render = function render() {
  ...
  }, [_vm._l(_vm.form.categories, function (category, index) {
    return _c("Category", {
      key: index,
      attrs: {
        category: category,
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "pr-2 w-3/6 lg:w-[30%]"
  }, [_c("v-select", {
    attrs: {
      items: _vm.dataCategories,
      "item-value": "id",
      "item-text": "name"
    },
    on: {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        var item = _ref.item;
        return [_c("span", {
          staticClass: "font-medium text-gray-900 text-xl tracking-tighter"
        }, [_c("i", {
    ...
    on: {
      change: function change($event) {
        return _vm.loadLabels(_vm.category);
      }
    },
    model: {
      value: _vm.category.sub_category_id,
      callback: function callback($$v) {
        _vm.$set(_vm.category, "sub_category_id", $$v);
      },
      expression: "category.sub_category_id"
    }
  }, [_c("template", {
    slot: "label"
  }, [_c("span", {
    ...
    staticClass: "w-3/6 lg:w-[30%] pr-2"
  }, [_c("v-select", {
    attrs: {
      items: _vm.subLabels,
      "item-value": "id",
    ...
    model: {
      value: _vm.category.sub_sub_category_id,
      callback: function callback($$v) {
        _vm.$set(_vm.category, "sub_sub_category_id", $$v);
      },
      expression: "category.sub_sub_category_id"
    }
  }, [_c("template", {
    slot: "label"
  }, [_c("span", {
    ...
    on: {
      click: function click($event) {
        $event.stopPropagation();
        return _vm.$emit("delete-category", _vm.index);
      }
    }
  }, [_c("i", {
    staticClass: "fas fa-trash text-red-800"
...
/***/ "./resources/js/pages/artwork/utils/CommonMixin.js":
/*!*********************************************************!*\
  !*** ./resources/js/pages/artwork/utils/CommonMixin.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
