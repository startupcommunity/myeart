...
/* harmony import */ var _mixins_utilMixin__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../mixins/utilMixin */ "./resources/js/mixins/utilMixin.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_mixins_getDataMixin__WEBPACK_IMPORTED_MODULE_3__["default"], _mixins_utilMixin__WEBPACK_IMPORTED_MODULE_4__["default"]],
  name: "ListArtwork",
  data: function data() {
    return {
      artworks: [],
  ...
  methods: {
    ...
    getArtworks: function getArtworks() {
      ...
      this.axios.get(this.ep.artworks.getPublish).then( /*#__PURE__*/function () {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 6:
                  ...
                  _this.remainingArtworks = _this.artworks.splice(countShowArt); // obras restantes
        ...
        return _this.loadingArtwork = false;
      });
    }
  }
});
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }), _vm._v(" "), _c("pre-header"), _vm._v(" "), _c("Header"), _vm._v(" "), _c("div", {
    staticClass: "relative z-[1] h-96 sm:h-[30rem] bg-no-repeat bg-cover bg-center",
    "class": "bg-hero-profile-bg"
  }, [_vm._m(0), _vm._v(" "), _c("div", {
    staticClass: "absolute top-0 bottom-auto pb-24 md:pb-20 lg:pb-24 inset-x-0 bg-gray-900 bg-opacity-60"
  })]), _vm._v(" "), _c("section", {
  ...
  }), 1)], 1)]), _vm._v(" "), _vm._m(2), _vm._v(" "), _c("div", {
    staticClass: "my-4"
  }, [_c("label", {
    staticClass: "uppercase text-zinc-900 tracking-widest text-xs font-bold"
  }, [_vm._v("\n                            Rango de precio\n                        ")]), _vm._v(" "), _c("v-slider", {
    ...
    model: {
      value: _vm.filters.leength,
      callback: function callback($$v) {
        _vm.$set(_vm.filters, "leength", $$v);
      },
      expression: "filters.leength"
    }
    ...
    return _c("div", {
      ...
      attrs: {
        src: (_vm$getProfilePhoto = _vm.getProfilePhoto(art.user)) !== null && _vm$getProfilePhoto !== void 0 ? _vm$getProfilePhoto : "/img/avatar.png",
        alt: "profile-picture"
      }
    }), _vm._v(" "), _c("div", {
      ...
      staticClass: "py-0"
    }, [_vm._v("\n                                                        " + _vm._s((_art$user = art.user) === null || _art$user === void 0 ? void 0 : _art$user.name) + "\n                                                    ")]), _vm._v(" "), _c("button", {
      ...
      staticClass: "fa-regular fa-heart text-red-800"
    })])])])])])])]);
  })], 2), _vm._v(" "), _c("div", {
...
var staticRenderFns = [function () {
  ...
  return _c("div", {
    staticClass: "absolute bottom-[40%] left-[35%] sm:left-[46%]"
  }, [_c("h1", {
    staticClass: "font-black tracking-widest text-white text-3xl uppercase"
  }, [_vm._v("\n                Pintura\n            ")])]);
}, function () {
  var _vm = this,
      _c = _vm._self._c;
  ...
  return _c("div", [_c("i", {
    ...
    staticClass: "uppercase text-zinc-900 tracking-widest text-xs"
  }, [_vm._v("\n                                pinturas\n                            ")])])]);
}, function () {
  var _vm = this,
      _c = _vm._self._c;
