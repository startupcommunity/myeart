...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getArtist: function getArtist() {
      ...
      var ep = this.$isUserGuest ? this.ep.guest.getArtist : this.ep.user.getArtist;
      this.globalLoading = true;
      this.axios.get("".concat(ep + id)).then(function (res) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    loadRatings: function loadRatings() {
      ...
      var ep = this.$isUserGuest ? this.ep.guest.getArtistRatings : this.ep.user.getArtistRatings;
      this.loading = true;
      this.axios.get(ep + this.artist.id).then(function (resp) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    loadReleases: function loadReleases() {
      ...
      var ep = this.$isUserGuest ? this.ep.guest.getAllUserForID : this.ep.releases.getAllUserForID;
      this.loading = true;
      this.axios.get(ep + this.artist.id).then(function (resp) {
        _this.original = JSON.parse(JSON.stringify(resp.data));
...
var render = function render() {
  var _vm$artist, _vm$artist2, _vm$artist3;
  ...
  }) : _vm._e(), _vm._v(" "), (_vm$artist2 = _vm.artist) !== null && _vm$artist2 !== void 0 && _vm$artist2.id ? _c("Release", {
    attrs: {
      artist: _vm.artist,
      title: "Publicaciones del artista"
    }
  }) : _vm._e(), _vm._v(" "), (_vm$artist3 = _vm.artist) !== null && _vm$artist3 !== void 0 && _vm$artist3.id ? _c("RatingUserSection", {
    attrs: {
      artist: _vm.artist,
